...
package com.example.mvvm_pattern_example.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      ...
      @NonNull TextView textLoginStatus, @NonNull TextView textView) {
    this.rootView = rootView;
    this.buttonLogin = buttonLogin;
    this.editTextPassword = editTextPassword;
    this.editTextUsername = editTextUsername;
    this.textLoginStatus = textLoginStatus;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_login_status;
      TextView textLoginStatus = rootView.findViewById(id);
      if (textLoginStatus == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, buttonLogin, editTextPassword,
          editTextUsername, textLoginStatus, textView);
    }
